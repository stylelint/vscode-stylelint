...
const { DisableMetadataLookupTable } = require('../disable-metadata-lookup-table');

/**
 * @param {{disableType: DisableReportRuleNames, rule: string, range: lsp.Range}} options
 * @returns {lsp.Diagnostic}
 */
const createDisableDiagnostic = ({ disableType, rule, range }) => {
	let message = '';
