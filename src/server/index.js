...
/** @type {LanguageServerModuleConstructor[]} */
const moduleConstructors = [
	require('./formatter').FormatterModule,
	require('./validator').ValidatorModule,
	require('./auto-fix').AutoFixModule,
	require('./code-action').CodeActionModule,
	require('./completion').CompletionModule,
];
