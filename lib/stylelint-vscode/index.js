...
// https://github.com/stylelint/stylelint/blob/9.10.1/lib/getPostcssResult.js#L69-L85
...
function processResults({results}) {
	// https://github.com/stylelint/stylelint/blob/9.10.1/lib/standalone.js#L112-L120
	if (results.length === 0) {
		return [];
	}
