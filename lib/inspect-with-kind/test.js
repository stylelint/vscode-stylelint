...
test('inspectWithKind()', t => {
	t.equal(
		inspectWithKind(true),
		'true (boolean)',
		'should append type when it takes a boolean.'
	);
	...
	t.equal(
		inspectWithKind(-0),
		'-0 (number)',
		'should append type when it takes a number.'
	);

	t.equal(
		inspectWithKind(1n),
		'1n (bigint)',
		'should not append type when it takes a bigint.'
	);
	...
	t.equal(
		inspectWithKind(null),
		'null',
		'should not append type when it takes null.'
	);
	...
	t.equal(
		inspectWithKind(new Set()),
		'Set {}',
		'should not append type when it takes a Set.'
	);

	t.equal(
		inspectWithKind(new Map()),
		'Map {}',
		'should not append type when it takes a Map.'
	);
