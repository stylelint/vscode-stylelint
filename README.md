...
Set stylelint [`ignorePath`](https://stylelint.io/user-guide/usage/options#ignorepath) option. A path to a file containing patterns describing files to ignore.
